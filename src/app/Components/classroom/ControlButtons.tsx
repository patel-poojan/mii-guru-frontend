            ...
            <ul className="flex flex-wrap justify-between md:items-center place-items-end">
              ...
              <li>
                ...
                >
                  ...
                  {minusTen&&(<span className="absolute top-[2px] md:top-[3px] right-10 md:right-11 text-xs">-10s</span>)}
                </button>
              </li>
              <li>
                <button
              ...
              <li>
                <button
                  className={`relative flex flex-col items-center gap-1  transition-all duration-300 ${isForwardEnabled?"hover:scale-110":"opacity-40"}`}
                  disabled={!isForwardEnabled}
                  onClick={handleForwardBtnClick}
                >
                  <FaForward className="h-5 w-5" />
                  <span className="text-xs">Forward</span>
                  {plusTen&&(<span className="absolute top-[2px] md:top-[3px] -right-4 md:-right-5 text-xs">+10s</span>)}
                </button>
              </li>
              {/* speed  */}
              {/* <li>
